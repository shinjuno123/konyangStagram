...
#     account_id = models.CharField(max_length=100,primary_key=True)   # 아이디
#     password = models.CharField(max_length=50)                       # 비밀번호
#     name = models.CharField(max_length=30)                           # 이름
#     major = models.CharField(max_length=30)                          # 학과
#     student_id = models.IntegerField()                               # 학번
#     user_email = models.EmailField(max_length=250)                   # 이메일
#     college_mail = models.EmailField(max_length=250)                 # 대학교 이메일
#     created_at = models.DateTimeField(auto_now_add=True)             # 사용자 생성일자
#     modified_at = models.DateTimeField(auto_now_add=True)            # 사용자 수정일자
...
#     account_id = models.OneToOneField("User_Info",on_delete=models.CASCADE)
...
#     bulletin_board_name = models.ForeignKey("Bulletin_board",on_delete=models.SET_NULL,null=True)
#     profile_id = models.ForeignKey("Profile",on_delete=models.CASCADE)
#     create_at = models.DateTimeField(auto_now_add=True)
#     modified_at = models.DateTimeField(auto_now_add=True)
