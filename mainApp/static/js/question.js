...
function QAFunc() {
    ...
    document.getElementById('logo-board').addEventListener('click',QAboardFunc);
}
...
window.addEventListener('load',function(){ //문의사항 로고
    logoBoardIcon.style.display = "flex";
    logoBoard.innerHTML = QAClick.innerHTML;
})